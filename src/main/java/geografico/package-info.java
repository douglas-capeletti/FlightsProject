 ...
 * <ul>
 * <li>
 *   {@link geografico.Geodesic}, for direct and inverse geodesic
 *   calculations;
 * <li>
 *   {@link geografico.GeodesicLine}, an efficient way of
 *   calculating multiple points on a single geodesic;
 * <li>
 *   {@link geografico.GeodesicData}, the object containing the
 *   results of the geodesic calculations;
 * <li>
 *   {@link geografico.GeodesicMask}, the constants that let you
 *   specify the variables to return in {@link
 *   geografico.GeodesicData} and the capabilities of a {@link
 *   geografico.GeodesicLine};
 * <li>
 *   {@link geografico.Constants}, the parameters for the WGS84
 *   ellipsoid;
 * <li>
 *   {@link geografico.PolygonArea}, a class to compute the
 *   perimeter and area of a geodesic polygon (returned as a {@link
 *   geografico.PolygonResult}).
 * </ul>
 * <p>
 ...
 *   {@link geografico.Gnomonic} (courtesy of Sebastian Mattheis).
 * <li>
